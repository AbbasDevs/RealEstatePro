    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFavorites", x => new { x.FavoritedById, x.FavoritesId });
                    table.ForeignKey(
                        name: "FK_TenantFavorites_Properties_FavoritesId",
                        column: x => x.FavoritesId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenantFavorites_Tenants_FavoritedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantProperties", x => new { x.PropertiesId, x.TenantsId });
                    table.ForeignKey(
                        name: "FK_TenantProperties_Properties_PropertiesId",
                        column: x => x.PropertiesId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenantProperties_Tenants_TenantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantFavorites_FavoritesId",
                table: "TenantFavorites",
                column: "FavoritesId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantProperties_TenantsId",
